...
rf1_pred_prob = predict(object = rf1_prob, data = test_data)$predictions
rf1_pred_prob

rf1_auc = roc.curve(test_data$DELAYED, rf1_pred_prob[,2])$auc
rf1_auc

# Accuracy Precision    Recall        F1      AUC
#0.8326836 0.6109537 0.1630134 0.2573588      0.7098843
##################### BALANSIRANJE ##############################
...
rf2_pred_prob = predict(object = rf2_prob, data = test_data)$predictions
rf2_pred_prob

rf2_auc = roc.curve(test_data$DELAYED, rf2_pred_prob[,2])$auc
rf2_auc
#AUC = 0.7051523
####################################################################
...
rf3_pred_prob = predict(object = rf3_prob, data = test_data)$predictions
rf3_pred_prob

rf3_auc = roc.curve(test_data$DELAYED, rf3_pred_prob[,2])$auc
rf3_auc
#AUC = 0.7056376

data.frame(rf1_auc, rf2_auc, rf3_auc)
#rf1_auc   rf2_auc   rf3_auc
#0.7098843 0.7051523 0.7056376
